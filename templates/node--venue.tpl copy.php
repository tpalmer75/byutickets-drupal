...
<ul class="nav nav-tabs nav-stacked" id="sportTab">
...
<div class="tab-content">
  ...
  <?php if($seating) { ?> <div class="tab-pane" id="seating"><?php print $seating; ?></div> <?php } ?>
  <?php if($directions) { ?> <div class="tab-pane" id="directions"><?php print $directions; ?></div> <?php } ?>
  <?php if($parking) { ?> <div class="tab-pane" id="parking"><?php print $parking; ?></div> <?php } ?>
  <?php if($policies) { ?> <div class="tab-pane" id="policies"><?php print $policies; ?></div> <?php } ?>
  <?php if($guest) { ?> <div class="tab-pane" id="guest"><?php print $guest; ?></div> <?php } ?>
  <?php if($concessions) { ?> <div class="tab-pane" id="concessions"><?php print $concessions; ?></div> <?php } ?>
</div>
